...
public class CodeParser {
    ...
    // Regular expression pattern to match instances of a given keyword surrounded by non-alphanumeric characters
    Pattern pattern;

    /**
     * Constructs a CodeParser object with a regular expression pattern that matches instances of a given keyword 
    ...
    /**
     * Checks whether the input contains the keyword that was specified in the constructor.
