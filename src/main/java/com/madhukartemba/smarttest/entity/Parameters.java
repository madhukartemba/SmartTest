...
public class Parameters {
        ...
        public static Parameter<Boolean> SKIP_COMPILE = new Parameter<>("skipCompile", "skipc", false,
        "Flag to skip compilation before testing." );
        ...
        static {
                ...
                BOOLEAN_PARAMETER_MAP.put(Parameters.SKIP_COMPILE.getName(), Parameters.SKIP_COMPILE);
                BOOLEAN_PARAMETER_MAP.put(Parameters.SKIP_COMPILE.getAliasName(), Parameters.SKIP_COMPILE);
